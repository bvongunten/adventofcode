package ch.nostromo.adventofcode.year2022.day11;
...
public class Part1 extends BasePuzzle {
    ...
    private static final String EXPECTED_TEST_RESULT = "10605";
    ...
    private static class Monkey {
        ...
        public void inpsectItems() {
            for (Integer item : items) {
                inspectionCount++;

                int tempItemValue = item;
                int tempOperationValue = operationOnOld ? item : operationValue;
                ...
                tempItemValue = Math.floorDiv(tempItemValue, 3);
        ...
        public String toString() {
            return monkeyTitle + " items= " + items;
        }
    ...
    public String solvePuzzle(List<String> input) {
        ...
        Collections.sort(monkeys, new Comparator<Monkey>() {
            ...
            public int compare(Monkey o1, Monkey o2) {
                return Integer.compare(o1.getInspectionCount(), o2.getInspectionCount());
            }
        });

        Collections.reverse(monkeys);

        int solution = monkeys.get(0).getInspectionCount() * monkeys.get(1).getInspectionCount();
    ...
    private static List<Monkey> createMonkeys(List<String> input) {
        ...
        for (int i = 0; i < input.size(); i += 7) {
            ...
            for (String itemNr : itemNrs) {
                currentMonkey.getItems().add(Integer.valueOf(itemNr));
            }
