package ch.nostromo.adventofcode.year2022.day03;
...
public class Part2 extends BasePuzzle {
   ...
   private static final String EXPECTED_TEST_RESULT = "70";
    ...
    private char getCommonChar(String first, String second, String third) {
