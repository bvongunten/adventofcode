package ch.nostromo.adventofcode.year2022.day10;
...
public class Part2 extends BasePuzzle {
    ...
    private static final String EXPECTED_TEST_RESULT = "ELPLZGZL";
    ...
    public String solvePuzzle(List<String> input) {
        ...
        for (int cycle = 1; cycle < 240; cycle++) {
            ...
            if (crtRow >= signalStrength  && crtRow <= signalStrength + 2) {
                System.out.print("#");
            } else {
                System.out.print(".");
            }
